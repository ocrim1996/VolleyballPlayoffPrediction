...
if __name__ == '__main__':
    ...
    for i in range(50):
        ...
        for C in C_values:
            ...
            # Logistic Regression to find C_max through Cross-Validation.
            logmodel = LogisticRegression(solver='lbfgs', max_iter=200, C=C)
            score = cross_val_score(logmodel, X_train, y_train, cv=cv, scoring='f1')
        ...
        # Logistic Regression with C_max.
        logmodel = LogisticRegression(solver='lbfgs', max_iter=200, C=C_max)
